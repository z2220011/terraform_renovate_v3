...
resource "aws_s3_bucket" "logs" {
  bucket = "prod-logs-${data.aws_caller_identity.current.account_id}"
...
resource "aws_s3_bucket" "backups" {
  bucket = "prod-backups-${data.aws_caller_identity.current.account_id}"
